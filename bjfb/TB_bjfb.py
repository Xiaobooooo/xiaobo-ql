...
class Task(QLTask):
    ...
    def task(self, index: int, text: str, proxy: str):
        ...
        if dh == 'HF1':
            result = dh_hf1(session, timestamp)
            log.info(f'【{index}】{result}')
        if dh == 'EK':
